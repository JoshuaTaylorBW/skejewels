...
<html>
<head>
	<title>Skejewels / Friend Requests</title>
	<link rel="stylesheet" href="NotificationsRequests.css">
...
<script type="text/javascript">
	...
	function makeRequests () {
		...
		xmlhttp.open("GET","RequestBoxes.php", true);
		xmlhttp.send();
	 }
	 	function Declined (declinedId) {
		if(window.XMLHttpRequest){
			xmlhttp = new XMLHttpRequest();
		}else{
			xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
		...
		xmlhttp.open("GET","RequestDeclined.php?id=" + declinedId, true);
		xmlhttp.send();
		setTimeout(function(){
			location.reload(true);
		}, 200);
	}
	function Added (acceptedId) {
		if(window.XMLHttpRequest){
			xmlhttp = new XMLHttpRequest();
		}else{
			xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
		...
		xmlhttp.open("GET","RequestAccepted.php?id=" + acceptedId, true);
		xmlhttp.send();
		setTimeout(function(){
			location.reload(true);
		}, 200);
...
<div id="NotificationList">
	...
	<div id="NotificationBanner">
		<p id="BannerText">Friend Requests:</p>
	</div>
...
<div id="AddEvent">
	...
	<span id="EndingDates">End Date: </span>
	...
	<select id="EndingDay" placeholder="End Day... January">
	<!-- ask user for day event ends !-->
		...
		<span id="EndingTimes">End Hour: </span>
